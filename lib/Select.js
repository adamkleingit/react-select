...
var Select = (function (_React$Component) {
	...
	_createClass(Select, [{
		...
		value: function componentDidUpdate(prevProps, prevState) {
			...
			if (this.menu && this.focused && this.state.isOpen && !this.hasScrolledToOption) {
				if (this.props.scrollOnSelectOption) {
   ...
   */
		...
		value: function selectValue(value) {
			...
			var newInputValue = this.props.clearFilterOnSelect ? this.handleInputValueChange('') : this.state.inputValue;
...
Select.propTypes = {
	...
	clearFilterOnSelect: _propTypes2['default'].bool, // if true, selecting a value clears the filter
	clearOnlyInput: _propTypes2['default'].bool, // if true, clear doesn't clear the value, but only the input value
	clearRenderer: _propTypes2['default'].func, // create clearable x element
	clearValueText: stringOrNode, // title for the "clear" control
	clearable: _propTypes2['default'].bool, // should it be possible to reset value
	closeOnSelect: _propTypes2['default'].bool, // whether to close menu after selecting an option
	...
	scrollOnSelectOption: _propTypes2['default'].bool, // boolean to scroll the menu automatically on open to the currently focused / selected option
